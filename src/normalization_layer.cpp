...
void forward_normalization_layer(const layer l, network net)
{
    int k,b;
    int w = l.w;
    int h = l.h;
...
void backward_normalization_layer(const layer l, network net)
{
...
void backward_normalization_layer_gpu(const layer l, network net)
{
    ...
    int h = l.h;
    int c = l.c;
    pow_gpu(w*h*c*l.batch, -l.beta, l.norms_gpu, 1, net.delta_gpu, 1);
    mul_gpu(w*h*c*l.batch, l.delta_gpu, 1, net.delta_gpu, 1);
}
#endif
