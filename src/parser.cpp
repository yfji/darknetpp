...
local_layer parse_local(list *options, size_params params)
{
    ...
    local_layer l = make_local_layer(batch,h,w,c,n,size,stride,pad,activation);
...
convolutional_layer parse_convolutional(list *options, size_params params)
{
    ...
    convolutional_layer l = make_convolutional_layer(batch,h,w,c,n,groups,size,stride,padding,activation, batch_normalize, binary, xnor, params.net->adam);
...
{
    int groups = option_find_int_quiet(options, "groups",1);
    softmax_layer l = make_softmax_layer(params.batch, params.inputs, groups);
...
detection_layer parse_detection(list *options, size_params params)
{
    ...
    detection_layer l = make_detection_layer(params.batch, params.inputs, num, side, classes, coords, rescore);
...
cost_layer parse_cost(list *options, size_params params)
{
    ...
    cost_layer l = make_cost_layer(params.batch, params.inputs, type, scale);
...
maxpool_layer parse_maxpool(list *options, size_params params)
{
    ...
    maxpool_layer l = make_maxpool_layer(batch,h,w,c,size,stride,padding);
    return l;
}
...
dropout_layer parse_dropout(list *options, size_params params)
{
    ...
    dropout_layer l = make_dropout_layer(params.batch, params.inputs, probability);
    l.out_w = params.w;
    l.out_h = params.h;
    l.out_c = params.c;
    return l;
...
route_layer parse_route(list *options, size_params params, network *net)
{
    ...
    route_layer rl = make_route_layer(batch, n, layers, sizes);

    convolutional_layer first = net->layers[layers[0]];
    rl.out_w = first.out_w;
    rl.out_h = first.out_h;
    rl.out_c = first.out_c;
    for(i = 1; i < n; ++i){
        int index = layers[i];
